altspace.getThreeJSTrackingSkeleton().then(function(skeleton){
  ...
  new NativeComponent('n-skeleton-parent', {part: 'spine'}, push1).addTo(sim.scene);
  new NativeComponent('n-mesh-collider', {type: 'environment', convex: 'false'}, push2);
  new NativeComponent('n-skeleton-parent', {part: 'spine'}, push2).addTo(sim.scene);
  new NativeComponent('n-mesh-collider', {type: 'environment', convex: 'false'}, push3);
  new NativeComponent('n-skeleton-parent', {part: 'spine'}, push3).addTo(sim.scene);
  new NativeComponent('n-mesh-collider', {type: 'environment', convex: 'false'}, push4);
  new NativeComponent('n-skeleton-parent', {part: 'spine'}, push4).addTo(sim.scene);
